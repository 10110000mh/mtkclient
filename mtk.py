...
def main():
    ...
    if sys.platform == "win32":
          parser_script.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_printgpt.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_footer.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_e.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_es.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_wl.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_wf.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_w.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_rs.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_rf.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_rl.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_gpt.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          parser_r.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          da_keys.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          da_unlock.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          da_peek.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          da_poke.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          da_dump.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
          da_rpmb.add_argument('--libusb0', action="store_true", help='Use Libusb0 with filter install (must run as admin to install)')
